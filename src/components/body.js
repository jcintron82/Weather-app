...
import { FetchAPI, functionFloat, fiveDayDataFloat } from './header'
import '../App.css';
...
//State(s) for the 5 day outlook highs and lows
...
const handleChangeState = (e) => {
 ...
 const onClickSearch = (event) => {
  ...
  return (
    ...
    <body className="body">
    <div className='tabletViewForecastHeader'><div className='tempRowDesktop'>5 Day Forecast
    <div className='locationDiv'>{locationDiv}</div> </div>
  <div className = 'dataDivWrapper'>
      <div className='tempRowMobile'> 5 Day Forecast 
        <div className='locationDiv'>{locationDiv}</div>
        </div>
        
    <div className='mainDataWrap'><h5 className='fiveDayHeaders'>{ dayOneName }</h5>
    ...
    <div className='mainDataWrap'><h5 className='fiveDayHeaders'>{ dayTwoName }</h5>
    <div className='dataComponentsWrap'>
    ...
    <div className='mainDataWrap'><h5 className='fiveDayHeaders'>{ dayThreeName }</h5>
    <div className='dataComponentsWrap'>
    ...
    <div className='mainDataWrap'><h5 className='fiveDayHeaders'>{ dayFourName }</h5>
    <div className='dataComponentsWrap'>
    ...
    <div className='mainDataWrap'><h5 className='fiveDayHeaders'>{ dayFiveName }</h5>
    <div className='dataComponentsWrap'>
    ...
    <Input className='newLocationSearch' type='text'  onChange={ handleChangeCity } 
    required='required'/> </div>
   
    <div>
    <label className='labels'> City* </label> 
    <Input className='newLocationSearch' type='text'  onChange={ handleChangeState }/> </div>
  </div>
    </body>
