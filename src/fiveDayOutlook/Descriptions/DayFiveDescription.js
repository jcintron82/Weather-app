...
export function DayFiveDescription({className}) {
	const [desc, setDesc] = useState()



	functionFloat.processDayFiveDescription= async function processDayFiveDescription(data) {
...
export default DayFiveDescription;