...
export function DayThreeDescription({className}) {
	const [desc, setDesc] = useState()



	functionFloat.processDayThreeDescription= async function processDayThreeDescription(data) {
...
export default DayThreeDescription;